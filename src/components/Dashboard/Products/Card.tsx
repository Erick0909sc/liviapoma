...
function Card({
  ...
  return (
    <div className="bg-opacity-60 w-80 h-[98%]  hover:bg-opacity-100  md:w-80 md:h-[98%]   lg:w-80 lg:h-[72vh]  transition-transform duration-500 rotate-1.7 rounded-lg border-gray-600 border mb-6 bg-white ">
