...
const CustomImagePerfile = <FormValues,>({
    formik,
    fieldName,
    fieldNameTranslate,
    initialPhoto,
    ...
    return (
        <>
            ...
            <div className="mb-4 bg-white rounded-lg   flex justify-center items-center">
                <label htmlFor="image">
                    <div className="hover:cursor-pointer relative group lg:h-60">
                        <img
                        ...
                        <span className="hidden absolute inset-0 group-hover:flex justify-center items-center backdrop-blur-sm bg-black/30 text-white transition-all text-xl font-bold hover:text-3xl">
                            <span
                                className={`border-2 p-2 rounded-xl ${formik.values[fieldName]
...
export default CustomImagePerfile;
